#!/usr/bin/env python3
"""
Script to sample the first 5000 rows of CPER parquet files and save them as CSV.
"""
...
def sample_parquet_to_csv(parquet_file, output_csv=None, sample_size=5000):
    """
    Sample the first 5000 rows of a parquet file and save as CSV.
    ...
    Args:
        ...
        sample_size (int, optional): Number of rows to sample. Default is 5000.
...
def sample_all_parquet_files(directory=".", sample_size=5000):
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Sample the first 5000 rows of parquet files and save as CSV.')
    ...
    parser.add_argument('--sample-size', '-s', type=int, default=5000,
